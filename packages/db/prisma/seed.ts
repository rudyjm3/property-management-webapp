...
async function main() {
  ...
  const org = await prisma.organization.create({
    data: {
      ...
      activeModules: ['owner_portal', 'reporting_analytics', 'advanced_tenant_onboarding', 'advanced_payments_accounting', 'unit_intelligence', 'inspections_compliance', 'grounds_maintenance'],
    },
  });
